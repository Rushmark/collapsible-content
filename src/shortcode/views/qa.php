<dl class"ga--container">
	<dt class="ga--question" itemscope itemtype="https://schema.org/Question" data-show-icon"<?php echo $attributes['show_icon']; ?>" data-hide-icon"<?php esc_attr_e( $attributes['hide_icon'] ); ?>">
